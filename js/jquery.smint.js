...
(function () {
    $.fn.smint = function (options) {
        ...
        return $(".smint a").each(function (index) {
            ...
            optionLocs.push(
                Array(
                    $("div." + id).position().top - menuHeight,
                    $("div." + id).height() + $("div." + id).position().top,
                    id
                )
            );
            ...
            $(document).ready(function () {
                ...
                var originalTop = $(".smint").offset().top;

                // Reset the position of the .smint element to its original position
            ...
            var stickyMenu = function (direction) {
                ...
                if (scrollTop > stickyTop) {
                    ...
                    $(".smint")
                        .css({ position: "absolute", top: stickyTop })
                        .removeClass("fxd");
                }
                ...
                if (
                    optionLocs[index][0] <= scrollTop &&
                    scrollTop <= optionLocs[index][1]
                ) {
                    if (direction == "up") {
                        $("#" + id).addClass("active");
